...
Has 226 line(s). Calls functions:
...
Uses feature(s): _add-zsh-hook_, _alias_, _autoload_, _colors_, _export_, _is-at-least_, _setopt_, _zmodload_, _zstyle_
...
Called by:
 ...
 zinit-autoload.zsh/.zinit-self-update_check_for_update
 zinit-autoload.zsh/.zinit-self-update_core
